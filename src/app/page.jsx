        ...
        <div className={styles.container}>
          <div className={styles.wrapper}>
            ...
            <div className={styles.Mydiv}>
              ...
              <p><Link href="https://ntouedu-my.sharepoint.com/:p:/g/personal/01257073_o365_ntou_edu_tw/Edp749myQP1Pnd0G4Y2JXNgB73KuFIfc-QYCV0puF04FXA?e=hf1YIp" className={styles.link}>SLIDE SHOW</Link></p>
